...
Files
code.ipynb – Main project code
train_data_chatbot.csv – Training dataset
validation_data_chatbot.csv – Validation dataset

Example
User: I have a headache and cold.
Bot: It might be due to a viral infection. Drink plenty of water and rest.
